...
def simulate_date(
    ...
    if codes:
        ...
        # Auto-fallback: try r008_trade_watchlist_today.txt before erroring.
        _r008_path = SCRIPT_DIR / "r008_trade_watchlist_today.txt"
        _r008_picks = load_picks(_r008_path) if _r008_path.exists() else None
        if _r008_picks:
            ...
            log(f"Auto-loaded r008 watchlist: {_r008_path.name} ({len(_r008_picks)} codes) -> {sorted(_r008_picks.keys())}")
            ...
            log("Hint: run r001 collector with --watchlist-file r008_trade_watchlist_today.txt to generate date-scoped picks.")
            return 1
        else:
