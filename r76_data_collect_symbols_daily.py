...
- Single code on specific date:
    python xgraph/auto_trading/r76_data_collect_symbols_daily.py --date 20260508 --code 067310
- Multiple codes on specific date:
    python xgraph/auto_trading/r76_data_collect_symbols_daily.py --date 20260508 --code 067310,005930
- Full list from symbols file:
    python xgraph/auto_trading/r76_data_collect_symbols_daily.py --date 20260508 --symbols-file xgraph/auto_trading/r76_universe_symbols_master.csv
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--symbols-file", type=str, default=str(SCRIPT_DIR / "r76_universe_symbols_master.csv"), help="Path to r76_universe_symbols_master.csv")
